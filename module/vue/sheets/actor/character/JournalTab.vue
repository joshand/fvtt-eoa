...
<template>
	<section class="tab-journal">
		...
		<section class="player-notes">
			<div class="header"><Localized label="EoA.Labels.Notes" /></div>

			<Editor name="system.notes" :content="system.notes" button />
		</section>

		<section class="xp-journal">
			<div class="header"><Localized label="EoA.Labels.XPJournal" /></div>

			<div class="entries-header">
				<div><Localized label="EoA.Labels.Reason" /></div>
				<div />
				<div><Localized label="EoA.Labels.Amount" /></div>
				<div>
			...
			<div class="entries">
				<div v-for="(entry, index) in system.experienceJournal.entries" :key="index" class="entry">
					<div><Localized :label="`EoA.XPJournal.${entry.type}`" :format-args="entry.data" enriched /></div>
