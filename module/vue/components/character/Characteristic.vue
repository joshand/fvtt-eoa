...
const markSuperCharacteristicLabel = game.i18n.localize('EoA.Labels.MarkSuperCharacteristic');
const unmarkSuperCharacteristicLabel = game.i18n.localize('EoA.Labels.UnmarkSuperCharacteristic');
</script>
