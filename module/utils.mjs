 ...
 * (e.g. "eoa.actor-traits").
 * @returns {Promise}
 */
export async function preloadHandlebarsTemplates() {
  const partials = [
    // Shared Partials
    // "systems/eoa/templates/actors/parts/active-effects.hbs",
    // "systems/eoa/templates/apps/parts/trait-list.hbs",

    // Actor Sheet Partials
    // "systems/eoa/templates/actors/parts/actor-traits.hbs",
    // "systems/eoa/templates/actors/parts/actor-inventory.hbs",
    // "systems/eoa/templates/actors/parts/actor-features.hbs",
    // "systems/eoa/templates/actors/parts/actor-spellbook.hbs",
    // "systems/eoa/templates/actors/parts/actor-warnings.hbs",

    // Item Sheet Partials
    // "systems/eoa/templates/items/parts/item-action.hbs",
    // "systems/eoa/templates/items/parts/item-activation.hbs",
    // "systems/eoa/templates/items/parts/item-advancement.hbs",
    // "systems/eoa/templates/items/parts/item-description.hbs",
    // "systems/eoa/templates/items/parts/item-mountable.hbs",
    // "systems/eoa/templates/items/parts/item-spellcasting.hbs",
    // "systems/eoa/templates/items/parts/item-source.hbs",
    "systems/eoa/templates/items/parts/item-summary.hbs",

    // Journal Partials
    // "systems/eoa/templates/journal/parts/journal-table.hbs",

    // Advancement Partials
    // "systems/eoa/templates/advancement/parts/advancement-ability-score-control.hbs",
    // "systems/eoa/templates/advancement/parts/advancement-controls.hbs",
    // "systems/eoa/templates/advancement/parts/advancement-spell-config.hbs"
  ];

  const paths = {};
  for ( const path of partials ) {
    paths[path.replace(".hbs", ".html")] = path;
    paths[`eoa.${path.split("/").pop().replace(".hbs", "")}`] = path;
  }
...
function itemContext(context, options) {
  if ( arguments.length !== 2 ) throw new Error("#eoa-itemContext requires exactly one argument");
...
export function registerHandlebarsHelpers() {
  Handlebars.registerHelper({
    ...
    "eoa-groupedSelectOptions": groupedSelectOptions,
    "eoa-linkForUuid": linkForUuid,
    "eoa-itemContext": itemContext
  });
}
 ...
 * @param {string} configKeyPath          Key path within `CONFIG.eoa` to localize.
 * @param {object} [options={}]
 ...
 * @param {object} config  The `CONFIG.eoa` object to localize and sort. *Will be mutated.*
 */
 ...
 * @param {ActorEoA} actor
 * @param {Object<string,ItemEoA>} spellsMap
