...
async function sendToChat() {
	...
	const chatTemplate = await renderTemplate('systems/eoa/templates/chat/ability.hbs', templateData);
	...
	<div class="talent">
		...
		<div :class="`desc-container ${expanded ? 'active' : ''}`">
			<div v-if="effectiveTier" class="tier-container">
				<span class="tier"><Localized label="EoA.Labels.Tier" />: {{ effectiveTier }}</span>
			</div>
