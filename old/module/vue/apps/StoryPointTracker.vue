...
<template class="story-point-tracker">
	<div class="tracker">
		<header>
			<Localized label="EoA.StoryPoints.GM" />
			<a v-if="isGM" @click="resetStoryPoints" v-localize:title="'EoA.StoryPoints.Reset'"><i class="fas fa-arrows-rotate"></i></a>
		</header>
	...
	<div class="tracker">
		<header><Localized label="EoA.StoryPoints.Player" /></header>
